...
import { updateAdressOne, updateAddressTwo, updateAddressThree } from '../../ducks/reducer';
...
export default connect(mapStateToProps, { updateAdressOne, updateAddressTwo, updateAddressThree })(WizardNine);